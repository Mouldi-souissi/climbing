              ...
              <div class="grid-body">
                <div class="row">
                  <div class="col-md-3">
                    ...
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" class="icheck" /> Application
                      </label>
                    </div>
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" class="icheck" /> Design
                      </label>
                    </div>
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" class="icheck" /> Desktop
                      </label>
                    </div>
                    <div class="checkbox">
                      <label>
                    ...
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" class="icheck" /> Mobile
                      </label>
                    </div>
