...
function Blog() {
  return (
    <div>
      ...
      />
      <section class="blog-listing gray-bg pt-5">
        <div class="container">
                ...
                <div class="col-sm-6">
                  <div class="blog-grid">
                    <div class="blog-img">
                      ...
                      <a href="/">
                        <img
                          src="https://via.placeholder.com/400x200/D3D3D3/000000"
                          title=""
                          alt=""
                        />
                      </a>
                ...
                <div class="col-sm-6">
                  <div class="blog-grid">
                    <div class="blog-img">
                      ...
                      <a href="/">
                        <img
                          src="https://via.placeholder.com/400x200/87CEFA/000000"
                          title=""
                          alt=""
                        />
                      </a>
                ...
                <div class="col-sm-6">
                  <div class="blog-grid">
                    <div class="blog-img">
                      ...
                      <a href="/">
                        <img
                          src="https://via.placeholder.com/400x200/E0FFFF/000000"
                          title=""
                          alt=""
                        />
                      </a>
